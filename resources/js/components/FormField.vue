	...
	<default-field :field="field" :errors="errors">
		<template slot="field">
			<select class="form-control form-select"
					...
					name="" id="">
				<option :key="l.lang" v-for="l in localeVariants"
						:value="l.lang"
						:selected="currentLanguage === l.lang"
				>
					{{ l.label }}
				</option>
			</select>
...
export default {
	...
	mounted() {
		...
		const lang = _.get(this.$router, ['currentRoute', 'query', 'locale'], this.field.localeVariants[0].lang)
